...
export const READ_IMAGE_FILE_TOOL = {
  ...
  description: [
    "Read a single image file (PNG/JPEG/GIF/WebP/BMP) from the workspace and return its raw pixel bytes as a vision-capable base64 image content block.",
    "Use this when the user asks you to inspect, describe, compare, or reason about screenshots, charts, UI designs, exported diagrams, error dialogs, or any visual reference stored as a raster image.",
    ...
    "Hard size limit: 5 MB raw bytes. Larger images must be downsampled out-of-band before reading.",
    "Returns a short text summary (path, MIME, size) followed by one image content item. The vision pipeline in your client sees the pixels directly.",
